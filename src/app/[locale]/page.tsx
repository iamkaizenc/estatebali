      ...
      <section className="relative h-screen flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            <Link 
              href="/beta"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 rounded-full text-white font-medium transition-all duration-200 hover:scale-105 whitespace-nowrap"
            >
            ...
            <Link 
              href="/create"
              className="inline-flex items-center gap-2 px-6 py-3 bg-dark-200/50 hover:bg-dark-200/70 backdrop-blur-sm border border-white/10 rounded-full text-white font-medium transition-all duration-200 hover:scale-105 whitespace-nowrap"
            >
          ...
          <motion.p
            ...
            className="text-sm text-gray-400 mt-4 text-center max-w-2xl mx-auto"
          >
